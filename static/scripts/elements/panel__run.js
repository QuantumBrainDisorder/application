...
function panel__bar__run__energies(event) {
  ...
  function panel__bar__run__cc(event) {
    ...
    input += '"energy__levels__limit__top": "' + localStorage.getItem("panel__form__ldos__parameters__et") + '",'; 
    input += '"energy__levels__limit__bottom": "' + localStorage.getItem("panel__form__ldos__parameters__eb") + '",'; 
    input += '"energy__levels__resolution": "' + localStorage.getItem("panel__form__ldos__parameters__er") + '",'; 
